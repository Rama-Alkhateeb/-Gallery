...
const FoodsPic = () => {
    ...
    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                ...
                url: FoodsData[selectedIndex].img,
    ...
    const goToNextImage = () => {
        setSelectedIndex((prevIndex) => (prevIndex + 1) % FoodsData.length);
    };

    const goToPreviousImage = () => {
        setSelectedIndex((prevIndex) => (prevIndex - 1 + FoodsData.length) % FoodsData.length);
    };
        ...
        <div className="gallery">
            ...
            {selectedIndex !== null && (
                <div className="modal" onClick={closeModal}>
                    ...
                    <img className="modal-content" src={FoodsData[selectedIndex].img} alt="" />
                    <a href={FoodsData[selectedIndex].img} download style={{marginTop:'20px', display:'block', color:'white'}}> <i class="fa-solid fa-download"></i> </a>
